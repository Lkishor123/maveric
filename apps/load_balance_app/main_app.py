# main_app.py
# Main orchestrator for the Load Balancing CCO application pipeline.
...
# Assumes this app sits in a directory like 'apps/load_balance_app/',
# two levels up would be the project root.
...
def main():
    """
    Main function to run the Load Balancing CCO pipeline.
    ...
    BASE_DATA_DIR = os.path.join(APP_DIR, "generated_data") # Parent directory for all day data
    
    # Paths for BDT training assume a single representative set of data
    ...
    if args.preprocess_data:
        # Preprocess all days needed for training and testing
