...
class TestTrafficDemandModel(unittest.TestCase):
    ...
    def test_generate_spatial_layout_valid(self, mock_voronoi_scipy):
        ...
        mock_vor.regions = [[0, 1, 4], [1, 3, 4], [0, 2, 4], [2, 3, 4], [], [-1, 0, 1]]
    ...
    def test_distribute_ues_in_layout_valid_and_point_placement(self):
        ...
        mock_layout_simple = [
            ...
            {
                "bounds": [(11, 0), (12, 0), (12, 1), (11, 1)],
                "type": "commercial",
                "spatial_cell_id": 1,
                "area_sq_km": 1,
            },
        ]
        simple_time_params = {"total_ticks": 1, "time_weights": {"residential": [0.8], "commercial": [0.2]}}
        num_ues = 10

        ue_data_per_tick = self.traffic_model._distribute_ues_in_layout(mock_layout_simple, simple_time_params, num_ues)
    ...
    def test_distribute_ues_empty_layout(self):
        ...
        ue_data_per_tick = self.traffic_model._distribute_ues_in_layout([], self.time_params, self.num_ues_per_tick)
    ...
    def test_distribute_ues_missing_type_in_time_weights(self):
        ...
        time_params_missing_type = {"total_ticks": 1, "time_weights": {"residential": [1.0]}}

        mock_layout_multi_type = [
            {"bounds": [(0, 0), (1, 0), (1, 1), (0, 1)], "type": "residential", "spatial_cell_id": 0},
            {"bounds": [(1, 0), (2, 0), (2, 1), (1, 1)], "type": "commercial", "spatial_cell_id": 1},
            {"bounds": [(2, 0), (3, 0), (3, 1), (2, 1)], "type": "park", "spatial_cell_id": 2},
        ]
    ...
    def test_generate_traffic_demand_orchestration(self, mock_distribute_ues, mock_generate_layout):
        ...
        mock_distribute_ues.assert_called_once_with(mock_spatial_layout_output, self.time_params, self.num_ues_per_tick)
    ...
    def test_assign_space_types_proportions_normalization(self):
        ...
        with patch.object(GISTools, "area_of_polygon", return_value=1.0, create=True) if not hasattr(
            GISTools, "area_of_polygon"
        ) else patch("__main__.GISTools.area_of_polygon", create=True):
